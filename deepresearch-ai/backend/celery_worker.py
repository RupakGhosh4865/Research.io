...
def run_research_task(session_id: str, topic: str, thread_id: str, user_id: str):
    ...
    try:
        ...
        loop.run_until_complete(run_graph(session_id, topic, thread_id))
    except Exception as e:
        print(f"Graph failed: {str(e)}")
        from app.utils.streaming import publish_error_event
        publish_error_event(session_id, str(e), redis_client)
