         ...
         >
           <div className="relative">
             ...
             <div className="absolute inset-0 flex items-center justify-center">
               <Activity size={24} className="text-[#00d4ff] animate-pulse" />
             </div>
           </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4">
          {stats?.recent_sessions?.length > 0 ? (
            <AnimatePresence>
              {stats.recent_sessions.map((session: any, idx: number) => (
                <motion.div
                  key={session.id}
                  initial={{ opacity: 0, x: -20 }}
                  animate={{ opacity: 1, x: 0 }}
            ...
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="p-16 border-2 border-dashed border-white/5 rounded-3xl flex flex-col items-center gap-4 text-center"
            >
